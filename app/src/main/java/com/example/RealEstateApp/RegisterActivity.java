...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextView tv_login;
    EditText et_user_role, et_user_name, et_full_name, et_user_email, et_user_password, et_user_ConformPassword, et_user_phone;
    Button btn_register;
            ...
            public void onClick(View view) {
                ...
                if (c == 6) {
                    db.insertUser(new Users(et_user_name.getText().toString(),
                            ...
                            et_user_phone.getText().toString(),et_user_role.getText().toString()));
